      ...
      <div id="resume-wrap" className="inner max-960">
        ...
        <ul>
          <li>
            ...
            React JS, JavaScript ES 6, Node JS, Express, WordPress and Web Pack
            in an agile environment for a large web platform consisting of
            desktop, and mobile that powered 600+ well optimized media web
            sites.
          </li>
          <li>
          ...
          <li>
            ...
            HTML 5 rich media ads using JavaScript, AJAX, YouTube API, Facebook
            Live API, RSS, custom APIs and many other 3rd party APIs.
          </li>
          <li>
        ...
        <ul>
          <li>
            ...
            applications, games, and front-end development to ensure a polished
          ...
          <li>
            Utilized HTML5, jQuery, and CSS3 to design interactive and animated
            media banners and ads.
          </li>
          <li>
            Adjusted website components to ensure optimal performance and
            functionality, establishing cross-browser compatibility and reducing
            image sizes and http requests to reduce loading times.
          </li>
          <li>
            Develop and manage web content using WordPress, JavaScript, jQuery,
            jQuery Mobile, PHP, HTML5, CSS3, Bootstrap, Angular JS, Mezzanine,
            Sass and GIT.
          </li>
        </ul>
        <br />
          ...
          <li>
            ...
            <ul>
              <li>
                ...
                <ul>
                  <li>
                    Developed a WordPress website with back-end access to ensure
                    future development and design changes for company employees.
                  </li>
                  <li>
                    Designed a custom WordPress theme based on custom templates,
                    fields, and post types.
                  </li>
                  <li>
              ...
              <li>
                ...
                <ul>
                  <li>
                    Developed business websites on platforms like WordPress with
                    integrated graphics, utilizing the Adobe Creative Suite and
                    web standards to provide striking graphics and
                    functionality.
                  </li>
                  <li>
              ...
              <li>
                <b>Others:</b> Coney Island Saucery (2019), Finesse (2015), Hot
                Sauce Willie’s (2013 – 2015), Chelsea Guitars (2014), Takashi
                NYC (2013), Mud Village (2012), Mountain Cat Guitars(2011)
              </li>
            </ul>
          </li>
        </ul>
